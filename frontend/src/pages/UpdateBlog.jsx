...
const UpdateBlog = () => {
    ...
    const updateBlogHandler = async () =>{
        ...
        try {
            ...
            const res = await axios.put(`https://blog-app-9g6i.onrender.com/api/v1/blog/${id}`, formData, {
                headers:{
    ...
    const togglePublishUnpublish = async (action) => {
        try {
            const res = await axios.patch(`https://blog-app-9g6i.onrender.com/api/v1/blog/${id}`, {
                params: {
                    action
                },
                withCredentials:true
    ...
    const deleteBlog = async () => {
        try {
            const res = await axios.delete(`https://blog-app-9g6i.onrender.com/api/v1/blog/delete/${id}`,{withCredentials:true})
            if(res.data.success) {
